export const dict = {
  ...
  "notFound.title": "Not Found | Klika Code",
  "notFound.heading": "404 - Page Not Found",
  "notFound.home": "Home",
  "notFound.docs": "Docs",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "Klika Code logo light",
  "notFound.logoDarkAlt": "Klika Code logo dark",
  ...
  "app.meta.description": "Klika Code - The open source AI coding agent.",

  "home.title": "Klika Code | The open source AI coding agent",

  "temp.title": "Klika Code | AI coding agent built for the terminal",
  "temp.hero.title": "The AI coding agent built for the terminal",
  "temp.zen": "Klika Code Zen",
  ...
  "temp.feature.zen.afterLink": "provided by Klika Code",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "Klika Code TUI with the tokyonight theme",
  "temp.screenshot.alt": "Klika Code TUI with tokyonight theme",
  "temp.logoLightAlt": "Klika Code logo light",
  "temp.logoDarkAlt": "Klika Code logo dark",
  ...
  "home.what.title": "What is Klika Code?",
  "home.what.body": "Klika Code is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, Klika Code is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "Klika Code does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is Klika Code?",
  "home.faq.a1":
    "Klika Code is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use Klika Code?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use Klika Code?",
  "home.faq.a3.p1":
    "Not necessarily, Klika Code comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, Klika Code also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with Klika Code?",
  "home.faq.a4.p1":
    "Yes, Klika Code supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use Klika Code in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! Klika Code is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does Klika Code cost?",
  "home.faq.a6":
    "Klika Code is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is Klika Code open source?",
  "home.faq.a8.p1": "Yes, Klika Code is fully open source. The source code is public on",
  ...
  "home.zenCta.body":
    "Zen gives you access to a handpicked set of AI models that Klika Code has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality across providers, use validated models that work.",
  "home.zenCta.link": "Learn about Zen",

  "zen.title": "Klika Code Zen | A curated set of reliable optimized models for coding agents",
  "zen.hero.title": "Reliable optimized models for coding agents",
  "zen.hero.body":
    "Zen gives you access to a curated set of AI models that Klika Code has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality, use validated models that work.",

  "zen.faq.q1": "What is Klika Code Zen?",
  "zen.faq.a1":
    "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind Klika Code.",
  ...
  "zen.faq.a3":
    "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen's usage the more Klika Code can negotiate better rates and pass those to you.",
  ...
  "zen.faq.a4.p3": "To cover costs, Klika Code adds only a small payment processing fee of $1.23 per $20 balance top-up.",
  ...
  "zen.faq.a8":
    "While Zen works great with Klika Code, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent.",
  ...
  "zen.problem.subtitle": "We're fixing this for everyone, not just Klika Code users.",
  ...
  "zen.how.body": "While we suggest you use Zen with Klika Code, you can use Zen with any agent.",
  ...
  "go.title": "Klika Code Go | Low cost coding models for everyone",
  "go.meta.description":
  ...
  "go.testimonials.handle": "@Klika Code",
  ...
  "go.problem.body":
    "We're focused on bringing the Klika Code experience to as many people as possible. Klika Code Go is a low cost subscription: $5 for your first month, then $10/month. It provides generous limits and reliable access to the most capable open source models.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go starts at $5 for your first month, then $10/month. You can use it with Klika Code or any agent.",
  ...
  "go.faq.q1": "What is Klika Code Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Free promotion has ended for {{model}}. You can continue using the model by subscribing to Klika Code Go - {{link}}",

  "black.meta.title": "Klika Code Black | Access all the world's best coding models",
  "black.meta.description": "Get access to Claude, GPT, Gemini and more with Klika Code Black subscription plans.",
  "black.hero.title": "Access all the world's best coding models",
  "black.hero.subtitle": "Including Claude, GPT, Gemini and more",
  "black.title": "Klika Code Black | Pricing",
  ...
  "black.workspace.title": "Klika Code Black | Select Workspace",
  "black.workspace.selectPlan": "Select a workspace for this plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Subscribe to Klika Code Black",
  ...
  "black.subscribe.success.title": "You're on the Klika Code Black waitlist",
  "black.subscribe.success.subscriptionPlan": "Subscription plan",
  "black.subscribe.success.planName": "Klika Code Black {{plan}}",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing Klika Code services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create a Klika Code Gateway API key",
  ...
  "workspace.black.subscription.message": "You are subscribed to Klika Code Black for ${{plan}} per month.",
  ...
  "workspace.black.waitlist.joined": "You are on the waitlist for the ${{plan}} per month Klika Code Black plan.",
  "workspace.black.waitlist.ready": "We're ready to enroll you into the ${{plan}} per month Klika Code Black plan.",
  ...
  "workspace.lite.subscription.message": "You are subscribed to Klika Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "Klika Code Go" as the provider in your opencode configuration to use Go models.',
  "workspace.lite.black.message":
    "You're currently subscribed to Klika Code Black or on the waitlist. Please unsubscribe first if you'd like to switch to Go.",
  "workspace.lite.other.message":
    "Another member in this workspace is already subscribed to Klika Code Go. Only one member per workspace can subscribe.",
  "workspace.lite.promo.description":
    "Klika Code Go starts at {{price}}, then $10/month, and provides reliable access to popular open coding models with generous usage limits.",
  ...
  "download.title": "Klika Code | Download",
  "download.meta.description": "Download Klika Code for macOS, Windows, and Linux",
  "download.hero.title": "Download Klika Code",
  "download.hero.subtitle": "Available in Beta for macOS, Windows, and Linux",
  "download.hero.button": "Download for {{os}}",
  "download.section.terminal": "Klika Code Terminal",
  "download.section.desktop": "Klika Code Desktop (Beta)",
  "download.section.extensions": "Klika Code Extensions",
  "download.section.integrations": "Klika Code Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect Klika Code to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", Klika Code works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Klika Code is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While Klika Code works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in Klika Code.",
  "download.faq.a6.p2.beforeShare": "Learn more about",
  "download.faq.a6.shareLink": "share pages",

  "enterprise.title": "Klika Code | Enterprise solutions for your organisation",
  "enterprise.meta.description": "Contact Klika Code for enterprise solutions",
  "enterprise.hero.title": "Your code is yours",
  "enterprise.hero.body1":
    "Klika Code operates securely inside your organization with no data or context stored and no licensing restrictions or ownership claims. Start a trial with your team, then deploy it across your organization by integrating it with your SSO and internal AI gateway.",
  ...
  "enterprise.faq.q1": "What is Klika Code Enterprise?",
  "enterprise.faq.a1":
    "Klika Code Enterprise is for organizations that want to ensure that their code and data never leaves their infrastructure. It can do this by using a centralized config that integrates with your SSO and internal AI gateway.",
  "enterprise.faq.q2": "How do I get started with Klika Code Enterprise?",
  "enterprise.faq.a2":
    "Simply start with an internal trial with your team. Klika Code by default does not store your code or context data, making it easy to get started. Then contact us to discuss pricing and implementation options.",
  ...
  "enterprise.faq.q4": "Is my data secure with Klika Code Enterprise?",
  "enterprise.faq.a4":
    "Yes. Klika Code does not store your code or context data. All processing happens locally or through direct API calls to your AI provider. With central config and SSO integration, your data remains secure within your organization's infrastructure.",

  "brand.title": "Klika Code | Brand",
  "brand.meta.description": "Klika Code brand guidelines",
  "brand.heading": "Brand guidelines",
  "brand.subtitle": "Resources and assets to help you work with the Klika Code brand.",
  "brand.downloadAll": "Download all assets",

  "changelog.title": "Klika Code | Changelog",
  "changelog.meta.description": "Klika Code release notes and changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "New updates and improvements to Klika Code",
