...
const TIPS = [
  ...
  "Create {highlight}opencode.json{/highlight} for Klika Code server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place global TUI settings in {highlight}~/.config/opencode/tui.json{/highlight}",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.opencode/tools/{/highlight} to define Klika Code tools",
  ...
  "Use {highlight}klika-code --continue{/highlight} to resume the last session",
