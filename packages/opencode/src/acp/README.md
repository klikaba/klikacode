...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for Klika Code.
...
- **`session.ts`** - Session state management
  ...
  - Maps ACP sessions to internal Klika Code sessions
...
klika-code acp --cwd /path/to/project
```
...
- **Terminal Integration**: Full terminal support via Klika Code's bash tool
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":1}}' | klika-code acp
```
...
### Mapping to Klika Code

ACP sessions map cleanly to Klika Code's internal session model:
